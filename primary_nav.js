...
<meta name="robots" content="INDEX, FOLLOW"/>
    ...
    <meta name="SBC-SEARCH-PUBLISHDATE" content="2018-11-13T15:15:00.000-06:00"/>

    <!-- seo -->
    <title>error</title>
    <meta property="og:title" content="error"/>
    <meta name="description" content="Error Page"/>
    <meta name="og:description" content="Error Page"/>
    <meta name="keywords"/>

    <meta property="og:url" content="https://about.att.com/error.html"/>
    <link rel="canonical" href="https://about.att.com/error.html"/>
	...
	<meta name="twitter:image" content="https://about.att.com/ecms/dam/snr/DefaultThumbnails/logo_att_share.png"/>
	
	<script type="text/javascript" src="https://about.att.com/static/26a2607a2507a73f569b806233c9dc954522001624dcc5"  ></script><script type="text/javascript">
...
<link rel="apple-touch-icon-precomposed" href="/ui/corpcomm_internet_attus/1.0.0/images/apple-touch-icon-precomposed.png"/>
    ...
    <link rel="stylesheet" href="/ui/corpcomm_internet_attus/1.0.0/styles/main.css"/>
                    ...
                    <script>var w=window;if(w.performance||w.mozPerformance||w.msPerformance||w.webkitPerformance){var d=document;AKSB=w.AKSB||{},AKSB.q=AKSB.q||[],AKSB.mark=AKSB.mark||function(e,_){AKSB.q.push(["mark",e,_||(new Date).getTime()])},AKSB.measure=AKSB.measure||function(e,_,t){AKSB.q.push(["measure",e,_,t||(new Date).getTime()])},AKSB.done=AKSB.done||function(e){AKSB.q.push(["done",e])},AKSB.mark("firstbyte",(new Date).getTime()),AKSB.prof={custid:"684699",ustr:"",originlat:"0",clientrtt:"10",ghostip:"2.16.240.69",ipv6:false,pct:"10",clientip:"146.148.15.119",requestid:"46a05bb9",region:"45474",protocol:"",blver:14,akM:"dscx",akN:"ae",akTT:"O",akTX:"1",akTI:"46a05bb9",ai:"448720",ra:"false",pmgn:"",pmgi:"",pmp:"",qc:""},function(e){var _=d.createElement("script");_.async="async",_.src=e;var t=d.getElementsByTagName("script"),t=t[t.length-1];t.parentNode.insertBefore(_,t)}(("https:"===d.location.protocol?"https:":"http:")+"//ds-aksb-a.akamaihd.net/aksb.min.js")}</script>
                    </head>


    <body class="generic nav-company  ">
        
            <header id="att-about-header" class="header header--transparent" role="presentation"></header>
        

        
            <header id="att-microsite-header" class="header--secondary header--transparent" role="presentation">
...
<div class="component">
    <div class="banner    " data-type="image">
            ...
            <input type="hidden" class="contentFriendlyName" value="Page Not Found"/>
            <div class="banner__img">
                <picture>

                    <!--[if IE 9]>
                    <video style="display: none;"><![endif]-->
                    <source srcset="/ecms/dam/snr/Generics/error.jpg" media="(max-width: 767px)"/>

                    <source srcset="/ecms/dam/snr/Generics/error.jpg" media="(max-width: 1023px)"/>

                    <!--[if IE 9]></video><![endif]-->


                    <img src="/ecms/dam/snr/Generics/error.jpg" alt="Page Not Found"/>
                ...
                <div class="content__wrap ">
                    ...
                    <div class="banner__text ">
                            ...
                            <div class="banner__headline">
                                    ...
                                    <h1 class="banner__headline--text">Page Not Found</h1>
                            ...
                            <div class="banner__level3">The page you're looking for has moved, been replaced, or is currently unavailable to view.</div>
        ...
        <div class="featured-item   ">
				...
				<div class="item__content">
					<div class="content__wrap">
								...
								<h3 class="item__title">Bookmarks and External Links</h3>
							
							
							
								<div class="item__description">
									<p>If you previously bookmarked a page and have now reached this message, check to make sure the link was not shortened, or go to our home page to find the page from there.<br />
</p>
								</div>
        ...
        <div class="featured-item   ">
				...
				<div class="item__content">
					<div class="content__wrap">
								...
								<h3 class="item__title">Links From Within Our Site</h3>
							
							
							
								<div class="item__description">
									<p>We've been upgrading this site. If you selected a link on our site and reached this message, use the Back button to return to the previous page, or follow <a href="https://about.att.com/">this link</a> to our home page where you can browse or search for the information.</p>
								</div>
